...
<section class="notice">
 ...
 <div>
	...
	<button type="submit" style="margin: 10px" class="btn btn-primary btn-l">수정</button>
	<button type="submit" style="margin: 10px" class="btn btn-primary btn-l">삭제</button>
 </div>
 </section>
</body>
</html>